...
class PySimpleDvc(PythonPackage):
    ...
    depends_on("py-pandas@1.4.0:", when="python@3.8:3.10")
    depends_on("py-pandas@1.3.5:", when="python@3.10:3.11")
    depends_on("py-pandas@1.5.0:", when="python@3.11:3.12")
    depends_on("py-pandas@1.0.0:", when="python@3.6:3.7")
    depends_on("py-pandas@1.2.0:", when="python@3.7:3.8")
    depends_on("py-pandas@2.1.1:", when="python@4:3.12")
